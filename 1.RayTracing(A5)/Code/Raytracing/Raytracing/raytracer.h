...
public:
	...
	void MultiThreadFuncCalColorInRange(int i, int ** sample, int w1, int w2);
	void MultiThreadFuncResamplingInRange(int i, int ** sample, int w1, int w2);
	void MultiThreadRunDebugRun(int w1, int w2, int h1, int h2, bool resampling);
	void MultiThreadRun();
