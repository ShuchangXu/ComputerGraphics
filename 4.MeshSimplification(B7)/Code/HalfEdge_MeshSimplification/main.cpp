...
// Model
Transform eightTrans(glm::vec3(0.0f, 0.0f, 0.0f),//position
...
Transform teddyTrans(glm::vec3(0.0f, 0.0f, 0.0f),//position
                     glm::vec3(0.0f, 0.0f, 0.0f),//rotation
                     glm::vec3(1.0f, 1.0f, 1.0f) * 0.1f );//scale

Transform dinosaurTrans(glm::vec3(0.0f, 0.0f, 0.0f),//position
                        glm::vec3(0.0f, 0.0f, 0.0f),//rotation
                        glm::vec3(1.0f, 1.0f, 1.0f) * 0.05f );//scale

char modelpath[] = "models/teddy.obj";
Transform& modelTrans = teddyTrans;
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if(keys[GLFW_KEY_R]) myModel.ReloadModel();
        else if(keys[GLFW_KEY_M]) myModel.SimplifyOnce();
